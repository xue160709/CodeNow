...
![CodeNow 的入口、规则、工作流、专家切片和 API 参考占据固定槽位，项目事实在运行后生成](attachments/fig-5-1-codenow-toolbox.png)
...
![想法、PRD、准备契约、开发、自检、正式验收、证据与 as-built 事实沿流水线逐级交接](attachments/fig-5-2-state-handoff.png)
